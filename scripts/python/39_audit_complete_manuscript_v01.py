...
manuscript = Path("docs/complete_manuscript_draft_v0.2.md")
...
summary_file = out_dir / "complete_manuscript_v0.2_qc_summary.md"
detail_file = out_dir / "complete_manuscript_v0.2_qc_details.tsv"
...
with summary_file.open("w") as f:
    f.write("# Complete Manuscript Draft v0.2 QC Summary\n\n")
