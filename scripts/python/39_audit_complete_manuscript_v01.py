...
manuscript = Path("docs/complete_manuscript_draft_v0.3.md")
...
summary_file = out_dir / "complete_manuscript_v0.3_qc_summary.md"
detail_file = out_dir / "complete_manuscript_v0.3_qc_details.tsv"
...
with summary_file.open("w") as f:
    f.write("# Complete Manuscript Draft v0.3 QC Summary\n\n")
