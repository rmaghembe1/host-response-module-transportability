...
summary_file = out_dir / "complete_manuscript_v0.8_cmi_qc_summary.md"
detail_file = out_dir / "complete_manuscript_v0.8_cmi_qc_details.tsv"
...
with summary_file.open("w") as f:
    f.write("# Complete Manuscript Draft v0.8 CMI QC Summary\n\n")
