...
manuscript = Path("docs/complete_manuscript_draft_v0.6_cmi_front_matter_finalized.md")
...
summary_file = out_dir / "complete_manuscript_v0.6_cmi_qc_summary.md"
detail_file = out_dir / "complete_manuscript_v0.6_cmi_qc_details.tsv"
...
with summary_file.open("w") as f:
    f.write("# Complete Manuscript Draft v0.6 CMI QC Summary\n\n")
