# Complete Manuscript Draft v0.7 — CMI-Compliant Abstract Draft

Draft v0.7 incorporates the CMI-compliant structured abstract, shorter running heading and keywords into the clean v0.6 CMI-facing manuscript while preserving front matter, main text, supplementary table citations, submission route note and interpretation safeguards.
