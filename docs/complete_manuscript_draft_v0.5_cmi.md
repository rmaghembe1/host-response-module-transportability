...
Draft v0.5 adapts the audited v0.4 manuscript for Clinical Microbiology and Infection. It updates the title/front matter and abstract using the CMI-facing variant while preserving the v0.4 Methods, Results, Discussion, figure captions, Table 1 notes and interpretation safeguards.
