...
Draft v0.4 assembled from indexed manuscript package components. This version incorporates v0.3 QC wording fixes in the Methods and front matter source files.
