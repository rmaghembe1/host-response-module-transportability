...
Draft v0.1 assembled from indexed manuscript package components. This file is intended for internal review and section-level refinement before journal-specific formatting.
